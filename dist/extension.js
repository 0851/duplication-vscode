...
//根目录改变, 配置改变时重新执行
function init(f, provider, config) {
    return __awaiter(this, void 0, void 0, function* () {
...
class Provider {
    ...
    _onChanges(clones) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!clones) {
                clones = yield this.file.getClones();
            }
            ...
            errs.forEach((err) => {
                ...
                others.forEach((other) => {
                    ...
                    if (diagnostic) {
                        ...
                        diagnostic.relatedInformation = [new vscode_1.DiagnosticRelatedInformation(new vscode_1.Location(vscode_1.Uri.parse(other.sourceId), otherRange), 'duplication')];
...
function QuickPick(context, f, provider, config) {
    context.subscriptions.push(vscode_1.commands.registerCommand('extension.duplication', () => __awaiter(this, void 0, void 0, function* () {
        var _a;
        let sets = new Set();
        let clones = yield f.getClones();
        yield provider.onChanges(clones);
        clones.forEach((item) => {
            let keys = [
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.detectClones = exports.getDuplication = exports.filterDuplication = exports.getDuplicationItem = exports.exec = exports.detectOne = void 0;
...
function detectOne(detector, item) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (item) {
                res = yield detector.detect(item.filepath, item.content, item.format);
            }
        }
        catch (error) {
        }
...
exports.detectOne = detectOne;
function exec(files, detector) {
    return __awaiter(this, void 0, void 0, function* () {
        let clones = [];
        const detect = (entry, clones = []) => __awaiter(this, void 0, void 0, function* () {
            if (!entry) {
                return clones;
            }
...
function detectClones(datas, detector) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
const clones_1 = __webpack_require__(/*! ./clones */ "./src/utils/clones.ts");
...
class Store extends core_1.MemoryStore {
    constructor() {
        super();
    }
    removeBySourceId(sourceId, namespace) {
...
class Files extends eventemitter3 {
    constructor(config) {
        ...
        this.detector = new core_1.Detector(this.tokenizer, this.store, this.validators, {
    ...
    exec() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let datas = yield this.reads(paths);
            return datas;
        });
    }
    reads(filepaths) {
    ...
    getClones() {
        return __awaiter(this, void 0, void 0, function* () {
            let clones = (yield clones_1.detectClones(this.datas, this.detector)) || [];
            return clones;
        });
    }
    read(key) {
